...
const config = {
    ...
    spritesmith: {
        dirname: projects + 'item/images/icon-*.png',
        dist: projects + 'item'
    },
    img: {
        dirname: [projects + 'item/images/*.*', '!' + projects + 'item/images/icon-*.png'],
        dist: projects + 'dist/images'
    },
    font: {
        dirname: projects + 'dist/fonts/*.*',
        dist: projects + 'dist/font'
    },
    cssLint: {
...
gulp.task('css', function() {
    ...
    var processors = [
        autoprefixer({
            browsers: ['safari 5', 'ie 8', 'ie 9', 'opera 12.1'],
            cascade: false,
            remove: false
        }),
        cssnext(),
